...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      campaigns: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_campaigns_active_combat"
            columns: ["active_combat_id"]
            isOneToOne: false
      ...
      combat_participants: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["monster_id"]
            isOneToOne: false
            referencedRelation: "monster_library"
            referencedColumns: ["id"]
          },
          {
      ...
      monster_library: {
        ...
        Relationships: [
          {
            foreignKeyName: "monster_library_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      add_monsters_to_combat: {
        Args: { p_combat_id: string; p_count?: number; p_monster_id: string }
        Returns: undefined
      }
      end_combat: { Args: { p_combat_id: string }; Returns: undefined }
      generate_unique_invite_code: { Args: Record<string, never>; Returns: string }
      get_campaign_from_character: {
